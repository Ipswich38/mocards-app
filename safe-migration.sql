-- ===================================================================
-- MOCARDS SAFE MIGRATION SCRIPT
-- Handles existing tables and updates them safely
-- ===================================================================
...
-- Show demo clinics
SELECT 'Demo Clinics:' as info, clinic_code, clinic_name FROM clinics WHERE clinic_code = 'DEMO001';

-- ===================================================================
-- MIGRATION COMPLETE!
-- Your existing MOCARDS database has been safely updated.
-- All tables, indexes, triggers, and policies are now in place.
-- ===================================================================