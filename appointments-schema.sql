-- ===================================================================
-- MOCARDS APPOINTMENT BOOKING SYSTEM SCHEMA
-- Centralized appointment booking for card perks redemption
-- ===================================================================
...
-- Create appointment status history table for audit trail
...
CREATE INDEX idx_appointments_control_number ON public.appointments(control_number);
CREATE INDEX idx_appointments_clinic_id ON public.appointments(assigned_clinic_id);
CREATE INDEX idx_appointments_status ON public.appointments(status);
CREATE INDEX idx_appointments_date ON public.appointments(appointment_date);
CREATE INDEX idx_appointments_admin ON public.appointments(booked_by_admin_id);
CREATE INDEX idx_appointment_history_appointment ON public.appointment_status_history(appointment_id);
...
-- Permissive policies for demo (in production, implement proper user-based policies)
...
-- VERIFICATION
-- ===================================================================
SELECT 'Appointment booking schema created successfully!' as status;