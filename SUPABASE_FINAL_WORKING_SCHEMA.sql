-- ===============================================
-- MOCARDS FINAL WORKING DEPLOYMENT SCHEMA
-- ===============================================
-- Handles ALL conflicts - policies, tables, realtime, indexes
...
BEGIN
    ...
    DROP POLICY IF EXISTS "mocards_cards_policy_2024" ON app_cards.cards;
    ...
    DROP POLICY IF EXISTS "mocards_cards_policy_2025" ON app_cards.cards;
...
BEGIN
    ...
    EXECUTE 'CREATE POLICY "mocards_cards_policy_' || policy_suffix || '" ON app_cards.cards FOR ALL USING (true)';
...
EXCEPTION WHEN OTHERS THEN
    ...
    BEGIN
        ...
        EXECUTE 'CREATE POLICY "mocards_cards_policy_' || random_suffix || '" ON app_cards.cards FOR ALL USING (true)';
...
SELECT
    ...
    'All conflicts resolved - clean deployment completed!' as "RESULT";
