...
BEGIN
    ...
    BEGIN
        ALTER PUBLICATION supabase_realtime DROP TABLE app_cards.cards;
    EXCEPTION WHEN OTHERS THEN
        NULL;
    END;
...
CREATE POLICY "mocards_clinics_policy_2025" ON app_clinics.clinics FOR ALL USING (true);
CREATE POLICY "mocards_cards_policy_2025" ON app_cards.cards FOR ALL USING (true);
CREATE POLICY "mocards_appointments_policy_2025" ON public.appointments FOR ALL USING (true);
CREATE POLICY "mocards_redemptions_policy_2025" ON public.perk_redemptions FOR ALL USING (true);
...
BEGIN
    ...
    CREATE INDEX IF NOT EXISTS idx_clinics_code_v3 ON app_clinics.clinics(code);
    CREATE INDEX IF NOT EXISTS idx_clinics_email_v3 ON app_clinics.clinics(email);
    CREATE INDEX IF NOT EXISTS idx_cards_control_v3 ON app_cards.cards(control_number);
    CREATE INDEX IF NOT EXISTS idx_cards_clinic_v3 ON app_cards.cards(clinic_id);
EXCEPTION WHEN OTHERS THEN
