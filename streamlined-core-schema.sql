...
-- Function to assign cards to clinic
...
1. CARD GENERATION:
   - Admin creates card batches
   - System generates cards with auto control numbers and passcodes
   - Cards start as 'unassigned' status

2. CLINIC MANAGEMENT:
   - Simple clinic registration and management
   - Location-based organization
   - Status tracking (active/inactive)

3. CARD ASSIGNMENT:
   - Admin assigns batches of cards to clinics
   - Cards change from 'unassigned' to 'assigned'
   - Automatic tracking of assignment counts

4. CARD ACTIVATION:
   - Clinics can activate assigned cards
   - Cardholders can use activated cards
   - Simple perk system with 5 core services

This schema focuses on the core workflow without complex features.
*/