-- =============================================================================
-- CORRECTED SCHEMA V3.0 - PRODUCTION READY (FIXED)
-- =============================================================================
...
-- FIXED: Column name corrections and proper table structure
...
-- Default perk templates (CORRECTED - no updated_at column)
...
SELECT
  'Redemption Fields',
  CASE
    WHEN EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'card_perks' AND column_name = 'claimed_by')
    THEN '✅ Redemption fields added'
    ELSE '❌ Missing redemption fields'
  END;
